...
const NotificationPage: React.FC = () => {
  ...
  const allergenWarningCount = notifications.filter(
    (n) => n.type === "allergen_warning",
  ).length;
  const adverseReactionCount = notifications.filter(
    (n) => n.type === "adverse_reaction",
  ).length;
  const inspectionFailedCount = notifications.filter(
    (n) => n.type === "inspection_failed",
  ).length;
                  ...
                  <List.Item.Meta
                    ...
                    title={
                      <Space>
                        ...
                        <Tag color={typeInfo.color as any}>
                          {typeInfo.label}
                        </Tag>
                      </Space>
                    }
